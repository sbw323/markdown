...
def build_matlab_mcp_server():
    ...
    async def run_matlab_tests(args):
        test_path = args["test_path"]
        source_path = args.get("source_path", "src")
        cmd = (
    ...
    async def matlab_syntax_check(args):
        file_path = args["file_path"]
        cmd = (
            f"try, "
    ...
    async def read_mat_summary(args):
