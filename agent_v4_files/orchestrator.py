...
Current phase (v4): variable influent outer loop — run_campaign.m gains
a tranche loop over DYNINFLUENT_ASM3.mat, with a new dynamicInfluent_writer.m
and sim_days coupling through campaign_params.mat.
